...
$string['editordigestmismatch'] = 'The downloaded editor package does not match the SHA-256 digest published by GitHub and was rejected.';
$string['editordigestmissing'] = 'GitHub did not publish a SHA-256 digest for the editor asset {$a}. The package was not installed.';
...
$string['editorunsafezip'] = 'The editor package contains an unsafe file path and was rejected: {$a}';
...
$string['grademodel_help']    = 'Choose how this activity reports to the gradebook. "Per iDevice only" (the default): one column per gradable iDevice, so each exercise is graded separately. "Overall only": a single aggregated column for the whole resource (like SCORM).';
...
$string['import_done'] = 'Content imported from the source activity.';
$string['import_nosource'] = 'The source activity has no importable eXeLearning source (an .elpx package, or a SCORM exported with editable source).';
...
$string['migratescormnote'] = 'SCORM activities are migrated only when they were exported with editable source; their grades are copied to the overall grade. SCORM packages without an embedded source are skipped.';
...
$string['migratesummary'] = 'Migrated: {$a->migrated}. Already migrated: {$a->alreadymigrated}. Skipped: {$a->nosource}. Errors: {$a->error}.';
