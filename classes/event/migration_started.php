...
/**
 * The mod_exelearning migration started event.
 *
 ...
 * administrative bulk action rather than a teaching/participation event.
 *
 * @package    mod_exelearning
 * @copyright  2026 ATE (Área de Tecnología Educativa)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class migration_started extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return get_string('eventmigrationstarted', 'mod_exelearning');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' started migrating {$this->other['total']} " .
            "'{$this->other['sourcecomponent']}' activities into eXeLearning.";
    }
    ...
    protected function validate_data() {
        ...
        foreach (['sourcecomponent', 'total'] as $key) {
