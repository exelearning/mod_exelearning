 ...
 *
 * URL layout: `/mod/exelearning/editor/styles.php/{slug}/{filepath}`.
 *
 * Files are stored outside the plugin source tree at
 * `{dataroot}/mod_exelearning/styles/{slug}/`; this endpoint is the only way
 * the embedded editor reaches them. Access requires `mod/exelearning:view`
...
// authenticated admin/teacher context; we still gate on mod/exelearning:view
