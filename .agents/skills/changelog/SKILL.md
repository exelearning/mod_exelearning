...
If `CHANGELOG.md` does not exist yet, create it with a single `# CHANGELOG` heading and then insert the new block underneath.
...
- Show the eXeLearning "Edit" button on the activity view when the package can be edited.
